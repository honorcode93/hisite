					...
					React.createElement("div", {className: "panel panel-default"}, 
						React.createElement("div", {className: "panel-heading"}, 
							React.createElement("h1", {className: "panel-title"}, 
								React.createElement("b", null, "Statistics")
							)
						), 
						React.createElement("div", {className: "panel-body"}, 
							React.createElement("div", {className: "tabbable player-stats-section", id: "tabs-640957"}, 
								React.createElement("ul", {className: "nav nav-tabs"}, 
									React.createElement("li", {className: "active"}, 
										React.createElement("a", {href: "#panel-1", "data-toggle": "tab"}, "Survivor")
									), 
									React.createElement("li", null, 
										React.createElement("a", {href: "#panel-2", "data-toggle": "tab"}, "Detective")
									), 
									React.createElement("li", null, 
										React.createElement("a", {href: "#panel-3", "data-toggle": "tab"}, "Infected")
									)
									
								), 
								React.createElement("div", {className: "tab-content"}, 
									React.createElement(PlayerSurvStats, {source: "/getSurvStats/", steam_id: this.state.steam_id}), 
									React.createElement("div", {className: "tab-pane", id: "panel-163367"}
									)
								)
							)							
						)
...
if(document.getElementById('player-info-app')){
	React.render(React.createElement(PlayerInfo, null), document.getElementById('player-info-app'));
}
...
var PlayerMainInfo = React.createClass({displayName: "PlayerMainInfo",
	getInitialState: function(){
		return {
		...
		return(
			React.createElement("div", {className: "thumbnail"}, 
				...
				React.createElement("div", {className: "caption"}, 
					React.createElement("h3", null, this.state.info.last_name), 
					React.createElement("h5", null, "Last active: ", this.state.info.last_active), 
					React.createElement("ul", null, 
						React.createElement("li", null, "Points: ", commaSeparateNumber(this.state.info.points)), 
						React.createElement("li", null, "Karma: ", commaSeparateNumber(this.state.info.karma)), 
						React.createElement("li", null, "Total connection time: ", this.state.info.connection_time), 
						React.createElement("li", null, "Rounds Played: ", commaSeparateNumber(this.state.info.rounds_played)), 
						React.createElement("li", null, "Rounds Infected: ", commaSeparateNumber(this.state.info.rounds_infected)), 
						React.createElement("li", null, "Rounds Survivor: ", commaSeparateNumber(this.state.info.rounds_survivor)), 
						React.createElement("li", null, "Rounds Detective: ", commaSeparateNumber(this.state.info.rounds_detective))
					), 
...
var PlayerSurvStats = React.createClass({displayName: "PlayerSurvStats",
	getInitialState: function(){
		return {
			steam_id: this.props.steam_id,
			info: {
